    ...
    <main className="min-h-[calc(100vh-64px)] py-20 px-4 md:px-8 bg-[#00080f]">
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {team.map((member, i) => (
             <div key={i} className="bg-[#000d1a] border border-rose-500/10 rounded-xl p-6 hover:border-rose-500/30 transition-colors text-center">
               <div className="w-20 h-20 mx-auto rounded-full bg-rose-900/40 border-2 border-rose-500/20 mb-4 flex items-center justify-center text-2xl font-bold text-rose-400">
               ...
               <div className="flex items-center justify-center gap-3">
                 <a href="#" className="text-slate-500 hover:text-rose-400 transition-colors"><Globe className="w-4 h-4" /></a>
                 <a href="#" className="text-slate-500 hover:text-violet-400 transition-colors"><Code className="w-4 h-4" /></a>
               </div>
             </div>
          ))}
        </div>
