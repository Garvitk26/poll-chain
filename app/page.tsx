    ...
    <main className="flex flex-col min-h-screen">
      ...
      >
        <div ref={heroRef as any} className={`max-w-4xl mx-auto transition-all duration-1000 transform ${heroVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-rose-500/10 border border-rose-500/20 text-rose-400 text-sm font-medium mb-8 animate-bob1">
            <span className="w-2 h-2 rounded-full bg-rose-400 shadow-[0_0_8px_var(--rose)] animate-pulse" />
      ...
      {/* Features Section */}
      <section id="how-it-works" className="py-24 bg-[#000d1a] border-t border-rose-500/10 relative overflow-hidden">
        <div className="container mx-auto px-4 sm:px-6">
          ...
          >
            {/* Feature 1 */}
            <div className="bg-[#001224] p-8 rounded-2xl border border-rose-500/15 hover:border-rose-500/40 transition-colors group">
              <div className="w-14 h-14 rounded-xl bg-rose-500/10 flex items-center justify-center text-rose-400 mb-6 group-hover:scale-110 group-hover:rotate-3 transition-transform">
