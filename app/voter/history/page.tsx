...
export default function VoterHistory() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-[#000d1a] border border-indigo-500/15 rounded-xl shadow-lg overflow-hidden mt-6">
        <div className="overflow-x-auto">
          <table className="w-full text-left text-sm whitespace-nowrap">
            <thead className="bg-[#001224] border-b border-indigo-500/10 text-slate-400">
              <tr>
              ...
              {history.map((record, i) => (
                <tr key={i} className="hover:bg-indigo-500/5 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <span className="font-mono text-cyan-400 bg-cyan-500/10 border border-cyan-500/20 px-2 py-1 rounded">
                      {record.memo}
                    </span>
                  </td>
                  <td className="px-6 py-4">
