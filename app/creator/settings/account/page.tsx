  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8">
      ...
      <div className="bg-[#000d1a] border border-rose-500/15 rounded-xl p-6 md:p-8">
        <h2 className="text-lg font-semibold text-slate-200 mb-6 border-b border-rose-500/10 pb-2">Profile Defaults</h2>
        ...
        <div className="space-y-6 max-w-xl">
          ...
          <div>
             ...
             <div className="flex gap-3">
               {['#f43f5e', '#6366f1', '#8b5cf6', '#d946ef', '#f59e0b', '#f43f5e'].map(color => (
                 <div 
                   key={color} 
      ...
      <div className="bg-[#000d1a] border border-violet-500/15 rounded-xl p-6 md:p-8">
        <h2 className="text-lg font-semibold text-slate-200 mb-6 border-b border-violet-500/10 pb-2">Web3 Integrations</h2>
        
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-[#001224] p-4 border border-violet-500/20 rounded-lg">
          <div>
