...
export default function Level1StatusBadge() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <div 
        className={cn(
          "transition-all duration-300 ease-in-out overflow-hidden shadow-2xl border bg-black/90 backdrop-blur-xl border-cyan-500/20",
      ...
      >
        {!isOpen ? (
          <div className="flex h-full items-center justify-center gap-1.5 px-3">
            <span className="text-[10px] font-black text-cyan-500 uppercase tracking-tighter">LV1</span>
            {status.ready ? (
          ...
          <div className="p-5">
            ...
            <div className="mt-4 pt-3 border-t border-white/5">
               <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-[10px] font-black text-cyan-500 italic">L1 ✓</span>
               </div>
               <div className="h-1.5 w-full bg-white/5 rounded-full overflow-hidden">
                  <div 
                    className="h-full bg-cyan-600 shadow-[0_0_8px_rgba(6,182,212,0.6)] transition-all duration-700" 
