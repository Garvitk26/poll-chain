...
export default function Footer() {
  return (
    <footer className="bg-[#000d1a] border-t border-rose-500/10 pt-16 pb-8">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-1">
            ...
            <div className="flex gap-4">
              <a href="https://twitter.com" target="_blank" rel="noreferrer" className="w-8 h-8 rounded-full bg-rose-500/10 flex items-center justify-center text-rose-400 hover:bg-rose-500/20 transition-colors">
                <Globe className="w-4 h-4" />
              </a>
              <a href="https://github.com" target="_blank" rel="noreferrer" className="w-8 h-8 rounded-full bg-violet-500/10 flex items-center justify-center text-violet-400 hover:bg-violet-500/20 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3 flex flex-col text-sm text-slate-400">
              <li><Link href="/poll/explore" className="hover:text-rose-400 transition-colors">Explore Polls</Link></li>
              <li><Link href="/creator/polls/new" className="hover:text-rose-400 transition-colors">Create Poll</Link></li>
              <li><Link href="/verify" className="hover:text-rose-400 transition-colors">Verify Vote</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 flex flex-col text-sm text-slate-400">
              ...
              <li><Link href="/about/team" className="hover:text-rose-400 transition-colors">Team</Link></li>
        ...
        <div className="w-full h-px bg-rose-500/10 mb-8" />
